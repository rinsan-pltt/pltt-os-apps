...
per-request via `pltt_image_backend.api.core.secrets.read_secret` — only the env-tunable
knobs live here.
"""
...
LANGSMITH_PROJECT_DEFAULT = os.getenv("AGENT_LANGSMITH_PROJECT", "pltt-creative-agent")
