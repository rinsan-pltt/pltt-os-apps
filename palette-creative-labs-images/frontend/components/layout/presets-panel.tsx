...
interface PresetsPanelProps {
  categories: any[]
  onSelect: (categoryId: string, option: string, meta?: { previewUrl?: string }) => void
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
        <div className="flex flex-col gap-8">
          ...
          {/* Assets Section - Special Handling */}
          ...
          <div>
            <p className=" font-semibold" >{t("panels.myPresets")}</p>
            <p className="text-muted-foreground mt-2 font-medium text-sm" >{t("panels.myPresetsHint")}</p>
          </div>
