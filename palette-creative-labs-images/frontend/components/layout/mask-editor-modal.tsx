...
export function MaskEditorModal({
  ...
  const portalContainer = usePlttCreativePortalContainer()
  ...
  const host =
    ...
    (typeof document !== "undefined"
      ? ((document.querySelector("[data-pltt-creative-portal-root]") as HTMLElement | null) ??
        (document.querySelector("[data-pltt-creative-root]") as HTMLElement | null) ??
