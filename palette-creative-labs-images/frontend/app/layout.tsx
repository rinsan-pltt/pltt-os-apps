...
import { PlttCreativePortalProvider } from "@/components/ui/app-portal"
...
> {
  ...
  componentDidCatch(error: unknown, info: React.ErrorInfo) {
    ...
    console.error(`[pltt-creative] ${this.props.label} threw`, error, info)
  }
  render() {
    ...
    return (
      ...
      >
        <div style={{ fontWeight: 700, marginBottom: 6, fontSize: 14 }}>
          pltt-creative — {this.props.label} crashed
        </div>
...
function AppThemeRoot({
  ...
  return (
    <div
      ...
      data-pltt-creative-theme={theme}
      data-pltt-creative-root
    >
      <PlttCreativePortalProvider container={portalContainer}>
        {runtimeError ? (
          <div
            style={{
              flex: "0 0 auto",
          ...
          >
            <div style={{ fontWeight: 700, marginBottom: 4 }}>
              pltt-creative - {runtimeError.label}
            </div>
        ...
        [data-pltt-creative-portal-root] {
          isolation: isolate;
        }
        ...
        [data-pltt-creative-portal-root] [data-slot="dialog-overlay"],
        [data-pltt-creative-portal-root] [data-slot="alert-dialog-overlay"],
        [data-pltt-creative-portal-root] [data-slot="sheet-overlay"] {
          width: 100%;
          height: 100%;
        }

        [data-pltt-creative-portal-root] [role="dialog"],
        [data-pltt-creative-portal-root] [aria-modal="true"],
        [data-pltt-creative-portal-root] [data-slot="dialog-content"],
        [data-pltt-creative-portal-root] [data-slot="alert-dialog-content"],
        [data-pltt-creative-portal-root] [data-slot="sheet-content"] {
          max-height: calc(100% - 32px);
          overflow: auto;
        }

        [data-pltt-creative-portal-root] [data-radix-popper-content-wrapper] {
          max-width: 100%;
          max-height: 100%;
        }
      `}</style>
        <div
          ...
          // declared for `[data-pltt-creative-portal-root]` in globals.css
          // resolve correctly for portaled dialogs/popovers. In the scoped
          // published/OS build the `.dark` class theme does NOT reach this
          // portaled subtree by inheritance, so the tokens are re-declared there
