...
def upgrade() -> None:
    op.create_table(
        "pltt_storyboard_video_maker__projects",
    ...
    ensure_org_rls(op, "pltt_storyboard_video_maker__projects")
    ...
    op.create_table(
        ...
        sa.Column(
            "project_id",
            sa.String(64),
            sa.ForeignKey("pltt_storyboard_video_maker__projects.id", ondelete="CASCADE"),
            nullable=False,
            index=True,
        ),
    ...
    ensure_org_rls(op, "pltt_storyboard_video_maker__key_frames")

    op.create_table(
        "pltt_storyboard_video_maker__key_frame_assets",
        sa.Column("id", sa.String(64), primary_key=True),
        sa.Column("organization_id", sa.BigInteger(), nullable=False, index=True),
        sa.Column(
            "key_frame_id",
            sa.String(64),
            sa.ForeignKey("pltt_storyboard_video_maker__key_frames.id", ondelete="CASCADE"),
            nullable=False,
            index=True,
        ),
    ...
    ensure_org_rls(op, "pltt_storyboard_video_maker__key_frame_assets")
    ...
    ensure_org_rls(op, "pltt_storyboard_video_maker__items")
    ...
    op.create_index(
        "ix_pltt_storyboard_video_maker__assets_user_content_hash",
        "pltt_storyboard_video_maker__assets",
        ["organization_id", "user_id", "content_hash"],
        unique=True,
        postgresql_where=sa.text("content_hash IS NOT NULL"),
    )
    ensure_org_rls(op, "pltt_storyboard_video_maker__assets")


def downgrade() -> None:
    op.drop_index("ix_pltt_storyboard_video_maker__assets_user_content_hash", table_name="pltt_storyboard_video_maker__assets")
    op.drop_table("pltt_storyboard_video_maker__assets")
    op.drop_table("pltt_storyboard_video_maker__items")
    op.drop_table("pltt_storyboard_video_maker__key_frame_assets")
    op.drop_table("pltt_storyboard_video_maker__key_frames")
    op.drop_table("pltt_storyboard_video_maker__projects")
