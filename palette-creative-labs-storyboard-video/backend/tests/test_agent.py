...
def test_agent_tools_and_routes_registered():
    ...
    from backend.api.agent.tools import get_tools
...
def test_agent_models_registered():
    ...
    from backend.api.models import AgentMessage, AgentThread, AgentThreadImage

    assert AgentThread.__tablename__ == "pltt_storyboard_video_maker__agent_threads"
    assert AgentMessage.__tablename__ == "pltt_storyboard_video_maker__agent_messages"
    assert AgentThreadImage.__tablename__ == "pltt_storyboard_video_maker__agent_thread_images"
