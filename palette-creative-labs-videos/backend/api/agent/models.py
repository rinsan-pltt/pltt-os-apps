...
class AgentThread(OrgScopedTable):
    ...
    __tablename__ = "pltt_creative_video__agent_threads"
...
class AgentMessage(OrgScopedTable):
    __tablename__ = "pltt_creative_video__agent_messages"

    id: Mapped[int] = mapped_column(_BigPk, primary_key=True, autoincrement=True)
    thread_id: Mapped[str] = mapped_column(
        String(64),
        ForeignKey("pltt_creative_video__agent_threads.id", ondelete="CASCADE"),
        index=True,
    )
...
class AgentThreadImage(OrgScopedTable):
    ...
    __tablename__ = "pltt_creative_video__agent_thread_images"
