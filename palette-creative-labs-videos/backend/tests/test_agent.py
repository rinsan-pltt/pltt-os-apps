...
def test_agent_models_registered():
    ...
    assert AgentThread.__tablename__ == "pltt_creative_video__agent_threads"
    assert AgentMessage.__tablename__ == "pltt_creative_video__agent_messages"
    assert AgentThreadImage.__tablename__ == "pltt_creative_video__agent_thread_images"
