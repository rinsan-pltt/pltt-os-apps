...
/** Compare-cell video with a thumbnail placeholder until its first frame loads. */
function CompareVideo({ src, poster }: { src: string; poster?: string | null }) {
        ...
        >
          {items.map((fav) => {
            ...
            return (
              ...
              >
                <CompareVideo src={fav.url} poster={fav.thumbnail_url} />
                {fav.group && (
                  <span
